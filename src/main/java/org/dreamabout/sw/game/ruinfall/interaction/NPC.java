...
public class NPC implements InteractiveObject {
    ...
    public NPC(String id, String displayName, String summary, int tileX, int tileY) {
    ...
    @Override public InteractiveObjectType getType() { return InteractiveObjectType.NPC; }
