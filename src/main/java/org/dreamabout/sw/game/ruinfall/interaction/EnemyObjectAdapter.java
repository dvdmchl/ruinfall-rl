...
public class EnemyObjectAdapter implements InteractiveObject {
    ...
    public EnemyObjectAdapter(String id, String displayName, String summary, int tileX, int tileY) {
    ...
    @Override public InteractiveObjectType getType() { return InteractiveObjectType.ENEMY; }
